...
export function AppContent() {
    ...
    const handleExportGuidePdf = async () => {
        ...
        try {
            await exportGuidePdf(activeStudy.guide);
        } catch (e) {
            console.error(e);
    ...
    const handleGenerateGuide = async () => {
        ...
        if (!check.allowed) {
            openUsageLimitModal(check.reason || 'monthly_limit');
            return;
        }
